...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello,</p>
            <p>Great news! Your 3D model processing for project <strong><?php echo e($upload->project_title); ?></strong> is complete and ready for download.</p>

            <div class="method-box">
                <?php if($method === 'portal'): ?>
            ...
            <p style="color: #e53e3e; font-weight: bold; margin-top: 20px;">
                <i class="bx bx-time"></i> Important: This download link will expire in 7 days (<?php echo e($upload->delivered_expires_at ? $upload->delivered_expires_at->format('M d, Y') : 'one week'); ?>).
                Please download and save your files locally before then.
            </p>

            <a href="<?php echo e(url('/my-uploads')); ?>" class="btn">Go to Dashboard</a>
...
<?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/emails/processed-delivered.blade.php ENDPATH**/ ?>