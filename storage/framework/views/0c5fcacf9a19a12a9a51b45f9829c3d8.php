  ...
  <div class="container mt-4 mb-5 pb-5">
    ...
    <div class="profile-card">
      ...
      <div class="profile-row">
        ...
        <span class="profile-value" id="profile-sftp-host">172.21.107.151</span>
      </div>
      <div class="profile-row">
        <span class="profile-label">SFTP Port</span>
        <span class="profile-value text-primary fw-bold" id="profile-sftp-port">2223</span>
      </div>
            ...
            if (data.success) {
              if (data.sftpUsername) {
                ...
                if (document.getElementById('profile-sftp-port')) {
                  document.getElementById('profile-sftp-port').textContent = data.sftpPort || '2223';
                }
                if (document.getElementById('profile-sftp-host')) {
                  document.getElementById('profile-sftp-host').textContent = data.sftpHost || '172.21.107.151';
                }
              } else {
