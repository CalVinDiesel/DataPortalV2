  ...
  <div class="container mt-4 mb-5 pb-5">
    ...
    <div class="profile-card">
      ...
      <div class="profile-row">
        ...
        <span class="profile-value text-primary fw-bold" id="profile-sftp-port"><?php echo e(env('SFTP_USER_PORT', 2222)); ?></span>
      </div>
            ...
            if (data.success) {
              if (data.sftpUsername && data.sftpUsername !== 'Not set') {
                ...
                if (document.getElementById('profile-sftp-port')) {
                  document.getElementById('profile-sftp-port').textContent = data.sftpPort || '<?php echo e(env('SFTP_USER_PORT', 2222)); ?>';
                }
