    ...
    <div class="container">
      <div class="navbar navbar-expand-lg landing-navbar px-3">
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
          ...
          <!-- / Style Switcher -->
          <a href="<?php echo e(route('my_uploads')); ?>" class="btn btn-primary btn-sm me-2">My Upload</a>
        ...
        <div class="col-md-4">
          <div class="card selection-card text-center p-8 h-100">
            <div class="card-body">
              ...
              <button class="btn btn-primary btn-lg px-6" onclick="window.location.href='<?php echo e(route('upload_data')); ?>'">Select Data Portal</button>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card selection-card text-center p-8 h-100" id="gdriveCard">
            <div class="card-body">
              ...
              <button class="btn btn-primary btn-lg px-6" onclick="window.location.href='<?php echo e(route('upload_gdrive')); ?>'">Select Google Drive</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    document.getElementById('btnSftp').addEventListener('click', function() {
      if (window.userRole !== 'trusted' && window.userRole !== 'admin') {
        ...
        window.location.href = '<?php echo e(route('upload_sftp')); ?>';
      }
    });
  </script>
</body>
</html>
<?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/portal/create-project.blade.php ENDPATH**/ ?>