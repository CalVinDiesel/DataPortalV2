    ...
    <div class="layout-container">
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          <li class="menu-item"><a href="<?php echo e(route('admin_dashboard')); ?>" class="menu-link"><i class="menu-icon tf-icons bx bx-home-circle"></i><div>Dashboard</div></a></li>
          <li class="menu-item"><a href="<?php echo e(route('admin.add_3d_model')); ?>" class="menu-link"><i class="menu-icon tf-icons bx bx-cube"></i><div>Add 3D Model</div></a></li>
          <li class="menu-item"><a href="<?php echo e(route('admin.manage_map_pins')); ?>" class="menu-link"><i class="menu-icon tf-icons bx bx-map-pin"></i><div>Manage Map Pins</div></a></li>
          <li class="menu-item active"><a href="<?php echo e(route('admin.manage_showcase')); ?>" class="menu-link"><i class="menu-icon tf-icons bx bx-grid-alt"></i><div>Manage Showcase</div></a></li>
          <li class="menu-item"><a href="<?php echo e(route('admin.client_uploads')); ?>" class="menu-link"><i class="menu-icon tf-icons bx bx-cloud-upload"></i><div>Client Uploads</div></a></li>
          <li class="menu-item"><a href="<?php echo e(route('admin.manage_users')); ?>" class="menu-link"><i class="menu-icon tf-icons bx bx-user"></i><div>Manage Users</div></a></li>
          <li class="menu-item"><a href="<?php echo e(route('landing')); ?>" class="menu-link" target="_blank"><i class="menu-icon tf-icons bx bx-map"></i><div>View Portal</div></a></li>
        </ul>
      </aside>
      <div class="layout-page">
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme">
          ...
          <div class="navbar-nav-right d-flex align-items-center ms-auto">
            ...
            <button type="button" class="btn btn-sm btn-outline-secondary me-2" id="syncShowcaseFromJsonBtn">Sync from locations.json</button>
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold mb-4">Manage Showcase</h4>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="text-muted small">Choose a map pin to show in the landing page showcase. It must exist in <a href="<?php echo e(route('admin.manage_map_pins')); ?>">Manage Map Pins</a> first.</p>
  ...
  <script>
    (function () {
      ...
      function loadShowcase() {
        fetch(API_BASE + '/api/showcase').then(function (r) { return r.json(); }).then(function (rows) {
          ...
          if (!Array.isArray(rows) || rows.length === 0) {
            tbody.innerHTML = '<tr><td colspan="4" class="text-center text-muted">No showcase items yet. Add map pins from <a href="<?php echo e(route('admin.manage_map_pins')); ?>">Manage Map Pins</a>, then add them here.</td></tr>';
            return;
          }
          ...
          tbody.querySelectorAll('.edit-order-btn').forEach(function (btn) {
            btn.onclick = function () {
              ...
              fetch(API_BASE + '/api/showcase/' + id, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ display_order: newOrder }) })
      ...
      if (renumberBtn) renumberBtn.addEventListener('click', function () {
        var btn = this;
        btn.disabled = true;
        fetch(API_BASE + '/api/admin/showcase-renumber', { method: 'POST' })
      ...
      if (syncShowcaseBtn) syncShowcaseBtn.addEventListener('click', function () {
        var btn = this;
        btn.disabled = true;
        fetch(API_BASE + '/api/admin/seed-showcase-from-locations', { method: 'POST' })
          .then(function (r) { return r.json(); })
          .then(function (data) {
      ...
      document.getElementById('addConfirmBtn').addEventListener('click', function () {
        ...
        fetch(API_BASE + '/api/showcase', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ map_data_id: mapDataId, display_order: order }) })
      ...
      document.getElementById('deleteConfirmBtn').addEventListener('click', function () {
        ...
        fetch(API_BASE + '/api/showcase/' + pendingDeleteId + '?from=' + from, { method: 'DELETE' })
          .then(function (r) { return r.json(); }).then(function (data) {
...
<?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/admin/manage-showcase.blade.php ENDPATH**/ ?>