    ...
    <div class="layout-container">
      ...
      <nav class="admin-glass-nav">
        ...
        <div class="admin-nav-links d-none d-xl-flex">
          ...
          <a href="<?php echo e(route('admin.manage_users')); ?>" class="admin-nav-link active">Manage Users</a>
...
<?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/admin/manage-users.blade.php ENDPATH**/ ?>