...
<head>
    ...
    <title>3D Hub Viewer | <?php echo e($id); ?></title>
    

    <?php echo app('Illuminate\Foundation\Vite')->reactRefresh(); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/viewer/main.tsx', 'resources/css/app.css']); ?>
    <style>
...
<body>
    ...
    <div style="position: absolute; top: 20px; right: 20px; z-index: 9999;">
        <a href="<?php echo e(route('request_access')); ?>" style="
            display: flex;
            align-items: center;
            gap: 10px;
            padding: 12px 24px;
    ...
    <script>
        ...
        window.__viewerId = "<?php echo e($id); ?>";
        ...
        if (!window.location.search.includes('model=')) {
            ...
            url.searchParams.set('model', "<?php echo e($id); ?>");
            window.history.replaceState({}, '', url);
        }
    </script>
</body>
</html><?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/portal/3D-viewer.blade.php ENDPATH**/ ?>