...
<html lang="en" class="layout-navbar-fixed layout-wide" dir="ltr" data-skin="default" data-assets-path="<?php echo e(asset('assets')); ?>/" data-template="front-pages" data-bs-theme="light" katalonextensionid="ljdobmomdgdljniojadhoplhkpialdid"><head>
    <meta charset="utf-8">
  ...
  <!-- <link rel="stylesheet" href="<?php echo e(asset('assets')); ?>/vendor/css/pages/front-page-payment.css"> -->
    ...
    <!-- Helpers -->
    <script src="<?php echo e(asset('assets')); ?>/vendor/js/helpers.js"></script><style type="text/css">
  ...
  <body style="--bs-scrollbar-width: 16px;">
    <script>
      (function() {
        ...
        var LANDING = (window.location.origin || 'http://localhost:3000') + '/html/front-pages/<?php echo e(route('landing')); ?>';
    ...
    <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          <li class="nav-item">
            <a class="nav-link fw-medium" href="<?php echo e(route('landing')); ?>#landingHero">Home</a>
          </li>
          <li class="nav-item">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li id="navUserWrap" style="display:none;">
          ...
          <a href="subscriber-<?php echo e(route('login')); ?>" id="navSubscriberBtn" class="btn btn-outline-primary me-2" style="display:none;"><span class="d-none d-md-inline">Subscribe</span><span class="d-md-none">Subscribe</span></a>
    ...
    <div class="container text-center py-5">
      <div class="card p-5">
        <div class="card-body">
          ...
          <a href="<?php echo e(route('landing')); ?>" class="btn btn-primary">Return to Home</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start align-items-center">
      <div class="mb-2 mb-md-0 d-flex align-items-center flex-wrap justify-content-center justify-content-md-start gap-2">
        <a href="<?php echo e(route('landing')); ?>" class="app-brand-link d-flex align-items-center">
          <span class="app-brand-logo demo">
            <img src="<?php echo e(asset('assets')); ?>/img/front-pages/landing-page/3DHub logo1.png" alt="3DHub" style="height: 36px; width: auto; object-fit: contain; filter: brightness(4.2) contrast(1.35) drop-shadow(0 0 2px rgba(255,255,255,0.95)) drop-shadow(0 0 6px rgba(255,255,255,0.6));" />
          </span>
        </a>
...
<!-- Footer: End -->
    ...
    <!-- Page JS -->
  <!-- <script src="<?php echo e(asset('assets')); ?>/js/front-page-payment.js"></script> -->
    ...
    (function () {
      ...
      document.getElementById('pay-btn').addEventListener('click', async function () {
        ...
        var result = await stripe.confirmPayment({
          ...
          confirmParams: {
            return_url: "<?php echo e(route('payment')); ?>?success=1"
          }
        });
...
<?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/portal/payment-page.blade.php ENDPATH**/ ?>