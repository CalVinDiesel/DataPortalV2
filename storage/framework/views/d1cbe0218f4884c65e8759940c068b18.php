          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <form id="loginForm" method="POST" action="<?php echo e(route('login')); ?>">
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="your@email.com" autocomplete="username">
              </div>
...
<?php endif; ?>
            ...
            <div class="text-center small">
              Don't have an account? <a href="<?php echo e(route('request_access')); ?>" class="fw-medium">Request access</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    document.getElementById('btnLoginMicrosoft').addEventListener('click', function (e) {
      e.preventDefault();
      window.location.href = "<?php echo e(route('auth.microsoft')); ?>";
    });
...
<?php /**PATH C:\Users\User\.antigravity\Projects\DataPortalV2\resources\views/portal/login.blade.php ENDPATH**/ ?>