...
<html lang="en" class="layout-navbar-fixed layout-wide" dir="ltr" data-skin="default" data-assets-path="{{ asset('assets') }}/" data-template="front-pages" data-bs-theme="light" katalonextensionid="ljdobmomdgdljniojadhoplhkpialdid"><head>
    ...
    <meta name="robots" content="noindex, nofollow">
      ...
      <title>Reload Tokens | {{ config('app.brand_name', '3D Hub beta') }}</title>
      ...
      <meta name="description" content="Transform drone aerial images into 3D mesh models, basemaps, and digital surface models with 3D Hub.">
        ...
        <meta property="og:title" content="Reload Tokens | {{ config('app.brand_name', '3D Hub beta') }}">
        <meta property="og:type" content="website">
        <meta property="og:url" content="{{ config('app.url') }}/payment">
