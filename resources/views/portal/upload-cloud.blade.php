        ...
        <form id="cloudForm" novalidate>
          ...
          <div id="onedriveSection" style="display: none;">
            ...
            <div class="mb-3">
              ...
              <input type="url" id="onedriveLink" class="form-control" placeholder="https://1drv.ms/u/s!..." required>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="number" id="onedriveSize" class="form-control" placeholder="e.g. 5368709120" min="1" required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="number" id="onedriveCount" class="form-control" placeholder="e.g. 1200" min="1" required>
              </div>
            </div>
          </div>
          ...
          <div class="row g-2 mt-2">
            <div class="col-6">
              ...
              <input type="text" id="latitude" class="form-control" placeholder="0.0000">
            </div>
            <div class="col-6">
              <label class="form-label small">Longitude</label>
              <input type="text" id="longitude" class="form-control" placeholder="0.0000">
            </div>
          </div>
        </form>
      </div>
