...
<head>
    <meta charset="utf-8">
    <title>Your 3D Model Tiles Are Ready – {{ $quotation->purchase_id }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="header">
            ...
            <p>Your purchase order has been fulfilled — download your tiles now</p>
        </div>
        ...
        <div class="body">
            ...
            <div class="ready-box">
                ...
                <p>Log in to the portal and visit <strong>My Purchase Quotations</strong> to download your 3D model tiles.</p>
                @if($quotation->delivered_at)
                    <p style="font-size:12.5px; color:#6b7280; margin-top: 8px;">Made available on {{ $quotation->delivered_at->format('d M Y, h:i A') }}</p>
                @endif
            </div>
            ...
            <table class="info-table">
                <tr>
                    <td>Purchase ID</td>
                    <td><strong style="font-family: 'Courier New', monospace; color: #4f46e5;">{{ $quotation->purchase_id }}</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Amount Paid</td>
                    <td><strong style="color: #059669;">RM {{ number_format($quotation->quoted_price, 2) }}</strong></td>
                </tr>
                @endif
                <tr>
            ...
            <ul class="steps-list">
                ...
                <li>
                    ...
                    <div>Navigate to <strong>Purchase Quotation → My PurchaseQuotation</strong> in the top navigation bar</div>
                </li>
                <li>
                    <span class="step-num">3</span>
                    <div>Find your order <strong>{{ $quotation->purchase_id }}</strong> and click to expand it</div>
                </li>
                <li>
            ...
            {{-- CTA Button --}}
            <div class="cta-wrap">
                <a href="{{ url('/purchase-quotation/my') }}" class="cta-btn">⬇ Go to My Purchase Quotations</a>
            </div>
        ...
        {{-- Footer --}}
        <div class="footer">
            <p>This email was sent to <strong>{{ $quotation->user_email }}</strong> because you placed a purchase order on 3DHub Data Portal.</p>
            <p style="margin-top: 8px;">
                <a href="{{ url('/purchase-quotation/my') }}">My Quotations</a> &nbsp;·&nbsp;
