...
<head>
    <meta charset="utf-8">
    <title>Your 3D Model Tiles Are Ready Ã¢â‚¬â€œ {{ $inquiry->inquiry_id }}</title>
    <style>
        ...
        /* Header Ã¢â‚¬â€ green gradient matching the download button */
...
<body>
    <div class="wrapper">
        ...
        <div class="header">
            ...
            <p>Your inquiry order has been fulfilled Ã¢â‚¬â€ download your tiles now</p>
        </div>
        ...
        <div class="body">
            ...
            <div style="text-align: center;">
                <div class="badge-id">Ã°Å¸â€œâ€¹ {{ $inquiry->inquiry_id }}</div>
            </div>

            {{-- Ready highlight box --}}
            <div class="ready-box">
                <span class="check">Ã¢Å“â€¦</span>
            ...
            {{-- Order summary --}}
            <p class="section-title">Ã°Å¸â€œÂ Order Summary</p>
            ...
            <p class="section-title">Ã°Å¸Å¡â‚¬ How to Download</p>
            <ul class="steps-list">
                <li>
                ...
                <li>
                    ...
                    <div>Navigate to <strong>Inquiry Ã¢â€ â€™ My Inquiry</strong> in the top navigation bar</div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div>Click the <strong>Ã¢Â¬â€¡ Download 3D Model Tiles</strong> green button to start the download</div>
                </li>
            </ul>

            {{-- CTA Button --}}
            <div class="cta-wrap">
                <a href="{{ url('/inquiry/my') }}" class="cta-btn">Ã¢Â¬â€¡ Go to My Inquiries</a>
            </div>

            {{-- Notice box --}}
            <div class="notice-box">
                <strong>Ã°Å¸â€œÅ’ Important:</strong> Please keep a backup copy of the downloaded tiles after saving them. If you experience any issues with the download, contact our support team and we will assist you promptly.
            </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 8px;">
                <a href="{{ url('/inquiry/my') }}">My Inquiries</a> &nbsp;Ã‚Â·&nbsp;
                <a href="{{ url('/#landingContact') }}">Contact Support</a>
            </p>
            <p style="margin-top: 8px; color: #bbb;">Ã‚Â© {{ date('Y') }} 3DHub Data Portal. All rights reserved.</p>
        </div>
