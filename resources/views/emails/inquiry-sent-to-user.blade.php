...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <h1>ðŸ’¼ Your Quotation is Ready</h1>
        ...
        <div class="body">
            ...
            <p class="section-title">ðŸ“ Order Details</p>
            ...
            <div class="notes-box">
                <strong>ðŸ“ Notes from Our Team:</strong><br>
            ...
            <div style="background-color: #f0f7ff; border-left: 4px solid #0070f3; border-radius: 0 8px 8px 0; padding: 16px 20px; margin: 20px 0; font-size: 13.5px; color: #0050b3; line-height: 1.6;">
                <strong style="text-transform: uppercase; font-size: 11px; letter-spacing: 0.8px; color: #0070f3; display: block; margin-bottom: 8px;">âš ï¸ Important 3D Model Pricing Notices:</strong>
            ...
            <p class="section-title">ðŸ“Œ How to Proceed</p>
            <ul class="steps-list">
                <li>
