...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <h1>ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬Â New Inquiry Submitted</h1>
        ...
        <div class="body">
            ...
            <table class="info-table">
                ...
                <tr>
                    <td>Client Name</td>
                    <td>{{ $inquiry->user->name ?? 'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â' }}</td>
                </tr>
                <tr>
                    <td>3D Model</td>
            ...
            <a href="{{ url('/admin/inquiries') }}" class="cta-btn">Open Admin Panel ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</a>
        </div>
        <div class="footer">
            &copy; {{ date('Y') }} 3DHub Data Portal ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Admin Notification
        </div>
    </div>
</body>
</html>
