                  ...
                  <div class="modal-body">
                    ...
                    <div class="alert alert-secondary mb-3 d-none" id="detailSftpBox">
                      ...
                      <div class="small text-muted mb-2">
                        ...
                        <strong><span id="detailSftpHostDisplay">{{ config('filesystems.disks.sftp_delivery.host') ?: request()->getHost() }}</span></strong> | Port: <strong><span id="detailSftpPortDisplay">{{ env('SFTP_PORT', 2222) }}</span></strong> | User: <strong><span id="detailSftpUserDisplay">{{ config('filesystems.disks.sftp_delivery.username', 'tiquan') }}</span></strong>
                      </div>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="alert alert-info mb-3" id="deliverPathHintBox">
                        ...
                        <div class="small mb-2">
                          Connect to: <strong><span id="deliverHostDisplay">{{ config('filesystems.disks.sftp_delivery.host') ?: request()->getHost() }}</span></strong> | Port: <strong><span id="deliverPortDisplay">{{ env('SFTP_PORT', 2222) }}</span></strong> | User: <strong><span id="deliverUserDisplay">{{ config('filesystems.disks.sftp_delivery.username', 'tiquan') }}</span></strong>
                        </div>
