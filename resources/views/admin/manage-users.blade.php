          ...
          .then(function(users) {
            ...
            tbody.innerHTML = users.map(function(u) {
              ...
              var roleBadge = isRemoved
                ...
                : (isAdmin ? '<span class="badge bg-label-success">Admin</span>' : (isTrusted ? '<span class="badge bg-label-primary">Trusted</span>' : '<span class="badge bg-label-secondary">Registered</span>'));
