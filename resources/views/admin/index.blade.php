    ...
    <div class="layout-container">
      ...
      <nav class="admin-glass-nav">
        ...
        <div class="admin-nav-links d-none d-xl-flex">
          <a href="{{ route('admin_dashboard') }}" class="admin-nav-link active">Dashboard</a>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4 mb-4">
                <a href="{{ route('admin.add_3d_model') }}" class="card text-decoration-none h-100">
                  <div class="card-body">
              ...
              <div class="col-md-6 col-lg-4 mb-4">
                <a href="{{ route('admin.manage_map_pins') }}" class="card text-decoration-none h-100">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-lg me-3">
              ...
              <div class="col-md-6 col-lg-4 mb-4">
                <a href="{{ route('admin.manage_showcases') }}" class="card text-decoration-none h-100">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-lg me-3">
